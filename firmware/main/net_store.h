 ...
 * see wifi_store.h for the rationale). It removes the old limitation that a
 * box's endpoints were compile-time constants, so moving one to a different
 * broker/relay meant a reflash.
 *
